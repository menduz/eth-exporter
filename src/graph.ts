...
import { fetchErc20Txs, fetchInternalTxs, fetchTxs, InternalTx } from "./api"
import { drawGraph } from "./draw"
import { requestManager } from "./rpc"
...
export async function processGraph() {
  ...
  allowed.forEach(x => {
    graph.allowedContracts.add(normalizeAddress(x.platforms.ethereum))
  })
